 ...
 */
public class ThymeleafMasterLayoutViewResolver extends ThymeleafViewResolver {
...
//            return super.loadView(viewName, locale);
    ...
    private boolean isAjaxRequest(HttpServletRequest request) {
        ...
        if (LOG.isTraceEnabled()) {
            LOG.trace("Request URL: [" + request.getServletPath() + "]" + " - " + "X-Requested-With: [" + requestedWithHeader + "]" + " - " + "Returning: [" + result + "]");
        }
